...
def load_text_encoders(class_one, class_two, torch_dtype=None):
...
def main(args):
    ...
    text_encoder_one, text_encoder_two = load_text_encoders(text_encoder_cls_one, text_encoder_cls_two, weight_dtype)
            ...
            if args.validation_prompt and args.num_validation_images > 0 and epoch % args.validation_epochs == 0:
                ...
                if not args.train_text_encoder:
                    text_encoder_one, text_encoder_two = load_text_encoders(
                        text_encoder_cls_one, text_encoder_cls_two, weight_dtype
                    )
                pipeline = FluxPipeline.from_pretrained(
                    args.pretrained_model_name_or_path,
                    vae=vae,
